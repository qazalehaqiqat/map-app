...
var map = {
	...
	"./pages/stops/stops.module": [
		"./src/app/pages/stops/stops.module.ts",
		"pages-stops-stops-module"
	],
	"./pages/stops/tab1/number1/number1.module": [
		"./src/app/pages/stops/tab1/number1/number1.module.ts",
		"number1-number1-module"
	],
	"./pages/stops/tab1/number2/number2.module": [
		"./src/app/pages/stops/tab1/number2/number2.module.ts",
		"number2-number2-module"
	],
	"./pages/stops/tab1/number3/number3.module": [
		"./src/app/pages/stops/tab1/number3/number3.module.ts",
		"number3-number3-module"
	],
	"./pages/stops/tab1/tab1.module": [
		"./src/app/pages/stops/tab1/tab1.module.ts",
		"pages-stops-tab1-tab1-module"
	],
	"./pages/stops/tab2/num1/num1.module": [
		"./src/app/pages/stops/tab2/num1/num1.module.ts",
		"num1-num1-module"
	],
	"./pages/stops/tab2/num2/num2.module": [
		"./src/app/pages/stops/tab2/num2/num2.module.ts",
		"num2-num2-module"
	],
	"./pages/stops/tab2/num3/num3.module": [
		"./src/app/pages/stops/tab2/num3/num3.module.ts",
		"num3-num3-module"
	],
	"./pages/stops/tab2/tab2.module": [
...
/* harmony import */ var _providers_userProvider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../providers/userProvider */ "./src/providers/userProvider.ts");
/* harmony import */ var mapir_angular__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! mapir-angular */ "./node_modules/mapir-angular/fesm5/mapir.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"], mapir_angular__WEBPACK_IMPORTED_MODULE_12__["Map"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _providers_userProvider__WEBPACK_IMPORTED_MODULE_11__["UserProvider"],
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (phoneNumber, password) {
    ...
    LoginService.prototype.logout = function (phoneNumber, password) {
        // const user = {PhoneNumber: data.PhoneNumber, Password: 1};
        // console.log('data: ' , data);
        // console.log('user: ' , user);
        // console.log('json user: ' , JSON.stringify(user));
    ...
    LoginService.prototype.register = function (phoneNumber, password, lastName, name) {
        // const user = {PhoneNumber: data.PhoneNumber, Password: 1};
...
/* harmony import */ var _app_services_login_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app/services/login-service.service */ "./src/app/services/login-service.service.ts");
...
var UserProvider = /** @class */ (function () {
    function UserProvider(http, loginService) {
        this.http = http;
    ...
    UserProvider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _app_services_login_service_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"]])
    ], UserProvider);
    return UserProvider;
}());
...
module.exports = __webpack_require__(/*! D:\hybrid_mobile_app\Mapapp\src\main.ts */"./src/main.ts");
